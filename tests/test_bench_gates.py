...
def test_refresh_overall_gate2_fail_on_low_safety():
    report = {
        "meta": {"seed_list": [0, 1, 2, 3, 4]},
        "suites": [
            {
...
def test_refresh_overall_gate4_fail_on_strict_safety():
    report = {
        "meta": {"seed_list": [0, 1, 2, 3, 4]},
        "suites": [
            {
