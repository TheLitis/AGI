...
def test_shadow_toolcall_runtime_metrics_present_and_clean():
    ...
    assert float(train_stats.get("shadow_toolcall_steps", 0.0)) > 0.0
    ...
    assert "shadow_toolcall_steps" in eval_metrics
